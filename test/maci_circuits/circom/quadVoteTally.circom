...
template QuadVoteTally(
    ...
    signal input intermediatePathElements[k][1];
    ...
    var messageLength = 5;
    signal input stateLeaves[numUsers][messageLength];
    ...
    signal input currentSpentVoiceCredits;
    signal input currentSpentVoiceCreditsSalt;
    signal input newSpentVoiceCreditsSalt;
    ...
    signal input currentPerVOSpentVoiceCreditsSalt;
    signal input newPerVOSpentVoiceCreditsSalt;
